      ...
      <div className="container-site">
        ...
        <div className="mt-16 grid items-center gap-12 pb-16 lg:grid-cols-2 lg:gap-16 lg:pb-24">
          ...
          >
            ...
            {/* Google reviews badge — bottom-right corner, slightly outside the photo */}
            <motion.div
              className="absolute -bottom-6 -right-3 z-20 flex items-center gap-3 rounded-2xl border border-navy/5 bg-white/95 px-4 py-3 shadow-card backdrop-blur-sm lg:-right-6"
            ...
            >
              ...
              <div>
                <div className="flex items-center gap-1.5">
                  <span className="font-display text-lg font-bold text-navy">(5.0)</span>
                  <Star className="h-4 w-4 fill-amber-400 text-amber-400" aria-hidden="true" />
                </div>
                <p className="whitespace-nowrap text-sm font-semibold leading-tight text-navy/80">{t('about.reviewsBadge')}</p>
                <p className="whitespace-nowrap text-sm font-semibold leading-tight text-navy/80">{t('about.reviewsCount')}</p>
              </div>
            </motion.div>
          </motion.div>
